...
if __name__ == "__main__":
    ...
    parser.add_argument("--training-ratio", type=float, default=0.41, help="Fraction of GPUs for training pool")
    ...
    # Calculate GPU split
    num_training = int(args.total_gpus * args.training_ratio)
    num_inference = args.total_gpus - num_training
